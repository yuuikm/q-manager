  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link to="/documents" className="admin-card hover:shadow-lg transition-shadow duration-300 cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Documents</h3>
              <p className="text-gray-600">Manage system documents</p>
            </div>
        ...
        <Link to="/upload" className="admin-card hover:shadow-lg transition-shadow duration-300 cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Upload Document</h3>
              <p className="text-gray-600">Add new documents to the system</p>
            </div>
