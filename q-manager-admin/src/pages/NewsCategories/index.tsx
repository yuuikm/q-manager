    ...
    <div className="space-y-6">
      <div className="admin-card">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-2xl font-semibold text-gray-800">Управление категориями новостей</h2>
            <p className="text-gray-600 mt-1">Создавайте и редактируйте категории для новостей</p>
          </div>
          <div className="flex space-x-3">
            <button
              onClick={() => navigate(LINKS.newsLink)}
        ...
        {categories.length === 0 && (
          <div className="text-center py-8">
            <p className="text-gray-600 text-lg mb-4">Категории новостей не найдены</p>
